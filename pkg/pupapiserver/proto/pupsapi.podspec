Pod::Spec.new do |s|
  ...
  s.version  = '0.0.3'
  s.license  = '...'
  s.authors  = { 'Tyler Nettleton' => 'tyler@tylernettleton.com' }
  s.homepage = '...'
  s.summary = '...'
  ...
  src = '~/go/src/github.com/tylerjnettleton/go/pkg/pupapiserver/proto'

  # We'll use protoc with the gRPC plugin.
  s.dependency '!ProtoCompiler-gRPCPlugin', '~> 1.0'

  # Pods directory corresponding to this app's Podfile, relative to the location of this podspec.
  pods_root = '../../../apps/pups/Pods'
  project_root = '../../../apps/pups'
